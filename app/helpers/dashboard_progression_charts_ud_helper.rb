module DashboardProgressionChartsUdHelper
  def progression_resulting_color_ts
    ...
    pos_neg_progression_ud = (jan_progression_percentage + feb_progression_percentage + mar_progression_percentage + apr_progression_percentage + may_progression_percentage + jun_progression_percentage + jul_progression_percentage + aug_progression_percentage + sep_progression_percentage + oct_progression_percentage + nov_progression_percentage + dic_progression_percentage).to_f

    progression_color = if pos_neg_progression_ud >= 0
        "#93c54b"
      else
        "#d9534f"
      end
